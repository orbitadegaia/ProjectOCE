  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "orbit-yellow": "hsl(var(--orbit-yellow))",
      ...
      boxShadow: {
        glow: "var(--glow-orbit)",
        "glow-lg": "0 0 30px hsl(var(--orbit-yellow) / 0.5)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        glow: {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(var(--orbit-yellow) / 0.3)",
          },
          "50%": {
            boxShadow: "0 0 30px hsl(var(--orbit-yellow) / 0.6)",
          },
        },
        "pulse-glow": {
          "0%, 100%": {
